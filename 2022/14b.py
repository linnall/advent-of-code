...
def solution():
    ...
    with open('14.in', 'r') as file:
        ...
        for line in lines:
            ...
            for coor in coordinates[1:]:
                ...
                startCoor = [endX, endY]
    grid = [['.' for _ in range(maxCol + 500 + 1)] for _ in range(maxRow + 3)]
    ...
    return drop_sand(grid, maxCol, maxRow + 2)

        
    # test
    # for i in range(12):
    #     for j in range(440, 550):
    #         print(grid[i][j], end='')
    #     print('\n')
    # return 1 #drop_sand(grid, maxRow, maxCol)
